# 🏴‍☠️ Guia Rápido: SFY (UTMify / NexoFy Open-Source)

O **SFY** foi clonado com sucesso para a pasta:
`c:\Users\User\Downloads\INFOPRODUTOS\logpose`

---

## 🎯 O que é o SFY?
O SFY é uma plataforma completa e open-source criada especificamente para gestores de tráfego direto e produtores no Brasil, servindo como uma alternativa livre e sem mensalidade ao **UTMify** e **NexoFy**.
...
2. Crie um novo **Web Service** conectado ao repositório do SFY:
   - **Environment:** `Docker`
...
O SFY oferece um instalador em 1 clique na plataforma Ilumin Cloud:
